...
let virtual-env = "D:\Университет (магистратура)\2 семак\Управление проектами интеллектуальных информационных систем\Lab_1"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\Университет (магистратура)\2 семак\Управление проектами интеллектуальных информационных систем\Lab_1\Scripts\deactivate.nu"
